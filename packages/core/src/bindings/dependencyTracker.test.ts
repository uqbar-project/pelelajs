...
describe("DependencyTracker", () => {
  describe("registerDependency", () => {
    it("should register a dependency for a binding", () => {
      ...
      const binding = { element: document.createElement("div"), propertyName: "users", isInput: false };
    ...
    it("should register multiple dependencies for same binding", () => {
      const tracker = new DependencyTracker();
      const binding = { element: document.createElement("div"), propertyName: "user.name", isInput: false };
  ...
  describe("getDependentBindings", () => {
    it("should return bindings with exact path match", () => {
      const tracker = new DependencyTracker();
      const binding1 = { element: document.createElement("div"), propertyName: "users", isInput: false };
      const binding2 = { element: document.createElement("div"), propertyName: "items", isInput: false };
    ...
    it("should return bindings when changed path is parent of binding path", () => {
      const tracker = new DependencyTracker();
      const binding = { element: document.createElement("div"), propertyName: "users.0.name", isInput: false };
    ...
    it("should work with multiple binding types", () => {
      const tracker = new DependencyTracker();
      const valueBinding = { element: document.createElement("div"), propertyName: "message", isInput: false };
      const ifBinding = { element: document.createElement("div"), propertyName: "show", originalDisplay: "" };
      const classBinding = { element: document.createElement("div"), propertyName: "classes", staticClassName: "" };
  ...
  describe("path matching logic", () => {
    it("should match when binding path starts with changed path", () => {
      const tracker = new DependencyTracker();
      const binding = { element: document.createElement("div"), propertyName: "user.profile.name", isInput: false };
    ...
    it("should match when changed path starts with binding path", () => {
      const tracker = new DependencyTracker();
      const binding = { element: document.createElement("div"), propertyName: "user", isInput: false };
